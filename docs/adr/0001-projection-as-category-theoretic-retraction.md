...
* **Category Theory Formulation**: Retraction Invariant, Non-Section on Code, & Idempotent Projection
...
In category theory, a morphism $I: B \to A$ is a **retraction** of a morphism $P: A \to B$ if and only if:
