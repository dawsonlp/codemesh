...
from sample_project.gateways import EmailNotificationService, StripePaymentGateway
from sample_project.interfaces import DiscountStrategy, NotificationService, PaymentGateway
from sample_project.models import Money, Order, OrderItem, OrderStatus, PaymentStatus, User
from sample_project.repositories import OrderRepository, UserRepository
from sample_project.utils import generate_unique_id, log_execution
